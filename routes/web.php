...
Route::post('/admin/make-productManager/{id}', [AdminController::class, 'productManager'])->name('admin.productManager');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('products/{product}/forward', [ProductController::class, 'forward'])->name('products.forward')->middleware('can:forward,product');
